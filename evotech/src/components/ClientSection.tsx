        ...
        <ScrollAnimation direction="up">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              We deliver end-to-end IT and digital solutions to organizations in over{" "}
              <span className="font-semibold text-blue-600">15+ countries</span>,
              collaborating with prestigious institutions and enterprises worldwide.
            </p>
          </div>
        </ScrollAnimation>

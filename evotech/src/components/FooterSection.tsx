        ...
        <div className="border-t border-gray-700 mt-12 pt-6">
          <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400 gap-4">
            ...
            <div className="flex justify-center md:justify-end w-full md:w-1/3 space-x-5">
              <a href="mailto:info@evotechsolutions.com" className="hover:text-blue-400 transition"><Mail size={20} /></a>
              <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer" className="hover:text-blue-400 transition"><MapPin size={20} /></a>
              <a href="https://wa.me/919876543210" target="_blank" rel="noopener noreferrer" className="hover:text-green-500 transition"><MessageCircle size={20} /></a>
              <a href="tel:+919876543210" className="hover:text-blue-400 transition"><Phone size={20} /></a>
            </div>
          </div>
        </div>
      </ScrollAnimation>
